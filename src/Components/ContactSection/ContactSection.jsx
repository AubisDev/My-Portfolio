...
const ContactSection = () => {
    ...
    const openTag = '<';
    const closeTag = '/>';
    const inputStyles = 'mt-1 p-2 bg-transparent border border-sky-700 w-4/5 rounded-md shadow-sm shadow-sky-700 outline-none focus:border-sky-300 mb-4 ';
    const labelStyles = 'flex flex-col w-full ml-8 ';
    const btnStyles = 'w-3/5 mt-1 mb-4 py-2  bg-gradient-to-r from-sky-500 to-sky-600 hover:from-blue-600 hover:to-blue-700 rounded-lg';
    return (
            ...
            <div className='w-full h-full m-auto  text-slate-200 '>
                ...
                <div className='w-full h-full  '>
                    ...
                    <form onSubmit={handleSubmit(d => console.log(d))} className='flex flex-col justify-center items-center mt-8 border-white'>
                        ...
                        <textarea  {...register("message")} className={`${inputStyles} h-32 `} />
